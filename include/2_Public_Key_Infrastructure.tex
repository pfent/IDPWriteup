...
This can in turn be verified with cryptographic signatures again to reduce the trust to as few maunually exchanges keys
as possible.
...
All three of those certification solutions are based on the CA of the Deutsches Forschungsnetz (DFN)~\cite{dfnPki}, with
