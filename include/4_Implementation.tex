...
Several abstractions don't make sense, i.e.\ it was designed to support different so-called \say{Runtime Abstraction
Layers} (RALs), while none of that abstraction was needed.
Furthermore, the project was on first sight modularized with several \say{common} modules, which turned out to be tightly
