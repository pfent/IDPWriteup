...
Certificates require some fields regarding information of the user. % TODO
...
This identity management can also be used to authenticate the user. % TODO
...
% TODO: Automatic certificate process
% automatically fetch personal information / emails
% only require a single authentication step, while still having a secure system
% public keys published as soon as possible, so we get a privacy by default system
